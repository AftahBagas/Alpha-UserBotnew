...
if ENV:
    ...
    class Config(object):
        ...
        # send .get_id in your private channel to forward all your Private
        # messages
        ...
        NO_OF_BUTTONS_DISPLAYED_IN_H_ME_CMD = int(
            os.environ.get("NO_OF_BUTTONS_DISPLAYED_IN_H_ME_CMD", 12))
        # open load
        ...
        EMOJI_TO_DISPLAY_IN_HELP = os.environ.get(
