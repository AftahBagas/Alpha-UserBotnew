...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            ...
            await event.edit(f"`Alpha Jenis Yang Mau Anda Kunci Tidak Valid` `{input_str}`")
            return
...
async def rem_locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Apa Yang Harus Saya Buka Alpha ヅ`")
            return
        else:
            await event.edit(f"`Alpha Jenis Kunci Yang Mau Anda Buka Tidak Valid` `{input_str}`")
            return
    ...
    try:
        ...
        await event.edit(f"`Alpha Telah Membuka Kunci {what} Untuk Obrolan Ini ヅ`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Alpha Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
