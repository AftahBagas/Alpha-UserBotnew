...
CMD_HELP.update(
    {
        "musikdownload": "📚 **Cmd** : `.song<Penyanyi atau Band - Judul Lagu>`\
         \n📄 **Descriptions** : Mengunduh Sebuah Lagu Yang Diinginkan.\
         \n📚 **Cmd** : `.lirik` <Penyanyi atau Band - Judul Lagu>`\
         \n📄 **Descriptions** : Mencari Lirik Lagu Yang Diinginkan."
    }
)
