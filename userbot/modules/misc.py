...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Java-Userbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Java-Userbot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting Java-Userbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Java-Userbot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Java-Userbot Repo](https://github.com/Aftahbagas/Lord-Java/blob/Lord-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**╭┄┅┯┅┄──────┄┅┯┅┄╮**\n\n       [𝗝𝗔𝗩𝗔 𝗨𝗦𝗘𝗥𝗕𝗢𝗧](https://github.com/Aftahbagas/Lord-Java)\n\n**╰┄┅┷┅┄──────┄┅┷┅┄╯**\n"
    )
