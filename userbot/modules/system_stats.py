...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰─━═━═━═━═━═━═━═━═━─╯ \n"
        f"[Repo](https://github.com/Aftahbagas/Lord-Java) | [Grup Support](t.me/Javachatting) | [Owner](t.me/Kanjengingsun)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
