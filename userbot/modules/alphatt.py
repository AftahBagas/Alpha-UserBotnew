...
async def _(event):
    ...
    if ".com" not in d_link:
        await event.edit("`Mohon Maaf Alpha User, Saya Membutuhkan Link Video Tiktok Untuk Download Video Tiktok` **(._.)**")
    else:
...
CMD_HELP.update(
    {
        "tiktok": "📚 **Cmd** : `.tiktok <Link>`"
        "\n📄 **Descriptions** : Download Video Tiktok Tanpa Watermark"
    }
)
