...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/AftahBagas/Alpha.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/544752d0017cb5f5810b6.jpg"
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Alpha, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/Aftahbagas/Alpha.git)")
            else:
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo Alpha",
                                "https://github.com/Aftahbagas/Alpha"),
                            custom.Button.url(
                                "Pemilik Repo",
                                "t.me/Kanjengingsun")],
                    ],
